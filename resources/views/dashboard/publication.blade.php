    ...
    <form action=" " method="post">
            ...
            <div  class="container">
                <div  class="container col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" required name="notice" id="summernote" rows="3"></textarea>
                        <br>
        ...
        <div class="container">
            <div class="container col-md-10">
                <table class="table">
                    <thead>
                        <tr style="background-color: #E6E6FA; border: 20px;">
                    ...
                    <tbody>
                        ...
                        @foreach($data as $dd)
                            ...
                            <td>{!! $dd ->date !!}</td>
                            <td></td>
                            <td><a href="{{url('editpublication/'.$dd->id)}}" class="btn btn-primary">Edit</a></td>
                            <td><a href="{{url('deletepublication/'.$dd->id)}}" class="btn btn-danger">Delete</a></td>
