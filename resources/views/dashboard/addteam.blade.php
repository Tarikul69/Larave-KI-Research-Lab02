    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div style="background-color: gray;" class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{url('addteam01')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                    <select required class="form-control" name="role_type" id="cars">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6"><input name="photo" class="form-control" type="file"></div> 
                        </div> 

                        <div class="row  mb-4">
                        <label for="exampleFormControlTextarea1" class="col-md-4 col-form-label text-md-end form-lable">{{ __('Bio') }}</label>
                        <textarea class="col-md-6" name="bio" id="" rows="2"></textarea>
